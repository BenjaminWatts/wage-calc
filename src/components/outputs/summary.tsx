  ...
  return (
    <>
      <Paragraph>
        ...
        {r.financial.annual(takeHome.takeHomeTotal)}. This is the total you keep
        after paying taxes {r.financial.annual(takeHome.tax.total)}, childcare{' '}
        {r.financial.annual(takeHome.childcareTotal)} and other commuting costs{' '}
        {r.financial.annual(takeHome.onsiteCosts)} such as commuting, eating out
        and dog walking.
      </Paragraph>
      <Paragraph>
